var TicTacToeBoard = React.createClass({displayName: "TicTacToeBoard",
  ...
  eachGame: function(game) {
    return (
      React.createElement(Game, {key: game.id})
      );
  },
        ...
        React.createElement("table", {className: "table-tictactoe"}, 
          React.createElement("tr", {className: "tictactoe-grid-bottom"}, 
            React.createElement("td", {className: "tictactoe-grid-right"}, 
              React.createElement("button", {className: "space", "data-tag": "topLeft", onClick: this.play.bind(this, 0, 0, 'topLeft')}, this.state.board[0][0])
            ), 
            React.createElement("td", {className: "tictactoe-grid-right"}, 
              React.createElement("button", {className: "space", "data-tag": "topMid", onClick: this.play.bind(this, 0, 1, 'topMid')}, this.state.board[0][1])
            ), 
            React.createElement("td", null, 
              React.createElement("button", {className: "space", "data-tag": "topRight", onClick: this.play.bind(this, 0, 2, 'topRight')}, this.state.board[0][2])
            )
          ), 
          React.createElement("tr", {className: "tictactoe-grid-bottom"}, 
            React.createElement("td", {className: "tictactoe-grid-right"}, 
              React.createElement("button", {className: "space", "data-tag": "midLeft", onClick: this.play.bind(this, 1, 0, 'midLeft')}, this.state.board[1][0])
            ), 
            React.createElement("td", {className: "tictactoe-grid-right"}, 
              React.createElement("button", {className: "space", "data-tag": "midMid", onClick: this.play.bind(this, 1, 1, 'midMid')}, this.state.board[1][1])
            ), 
            React.createElement("td", null, 
              React.createElement("button", {className: "space", "data-tag": "midRight", onClick: this.play.bind(this, 1, 2, 'midRight')}, this.state.board[1][2])
            )
          ), 
          React.createElement("tr", null, 
            React.createElement("td", {className: "tictactoe-grid-right"}, 
              React.createElement("button", {className: "space", "data-tag": "botLeft", onClick: this.play.bind(this, 2, 0, 'botLeft')}, this.state.board[2][0])
            ), 
            React.createElement("td", {className: "tictactoe-grid-right"}, 
              React.createElement("button", {className: "space", "data-tag": "botMid", onClick: this.play.bind(this, 2, 1, 'botMid')}, this.state.board[2][1])
            ), 
            React.createElement("td", null, 
              React.createElement("button", {className: "space", "data-tag": "botRight", onClick: this.play.bind(this, 2, 2, 'botRight')}, this.state.board[2][2])
            )
          )
        )
      )
