...
var Category = React.createClass({displayName: "Category",
  ...
  handleClick: function(props) {
    // here we need to update the details block of the specific
    console.log('[Category] You clicked: ' + props.name);
  },
...
var Title = React.createClass({displayName: "Title",
  ...
  render: function() {
    return (
      React.createElement("div", {onClick: Category.handleClick.bind(this, this.state.titleData), className: "title-thumb col-xs-4"}, 
