var Netflix = React.createClass({displayName: "Netflix",
  ...
  eachCategory: function(category, i) {
    ...
    return (
      React.createElement(Category, {currentTitle: this.state.currentTitle, active: this.showActive, titles: category.titles, genre: category.genre, key: category.genre_id, index: i})
    );
  },
