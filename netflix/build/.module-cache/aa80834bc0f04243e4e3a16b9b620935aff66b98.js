var Netflix = React.createClass({displayName: "Netflix",
  ...
  eachCategory: function(category, i) {
    ...
    return (
      React.createElement(Category, {clickedTitle: this.state.active, active: this.showActive, titles: category.titles, genre: category.genre, key: category.genre_id, index: i})
    );
  },
...
var Category = React.createClass({displayName: "Category",
  ...
  render: function() {
    ...
    if (this.props.clickedTitle === this.state.activeTitle) {
      return (
