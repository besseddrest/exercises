        ...
        React.createElement("table", {className: "table-tictactoe"}, 
          React.createElement("tr", {className: "tictactoe-grid-bottom"}, 
            React.createElement("td", {className: "tictactoe-grid-right"}, 
              React.createElement(Button, {onClick: this.play, value: this.state.board[0][0]})
            ), 
            React.createElement("td", {className: "tictactoe-grid-right"}, 
              React.createElement(Button, {onClick: this.play, value: this.state.board[0][1]})
            ), 
            React.createElement("td", null, 
              React.createElement(Button, {onClick: this.play, value: this.state.board[0][2]})
            )
          ), 
          React.createElement("tr", {className: "tictactoe-grid-bottom"}, 
            React.createElement("td", {className: "tictactoe-grid-right"}, 
