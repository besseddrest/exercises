...
var Game = React.createClass({displayName: "Game",
  ...
  play: function(x, y) {
    ...
    this._disableCell(tag);

  },

  _disableCell: function(tag) {
    // TODO
    $('button[data-tag="' + tag + '"]').prop('disabled', true);
  },

  isDisabled: function(x, y) {
        ...
        React.createElement("table", {className: "table-tictactoe"}, 
          React.createElement("tr", {className: "tictactoe-grid-bottom"}, 
            React.createElement("td", {className: "tictactoe-grid-right"}, 
              React.createElement(Button, {onClick: this.play.bind(null, 0, 0), value: this.state.board[0][0]})
            ), 
            React.createElement("td", {className: "tictactoe-grid-right"}, 
              React.createElement(Button, {onClick: this.play.bind(null, 0, 1), value: this.state.board[0][1]})
            ), 
            React.createElement("td", null, 
              React.createElement(Button, {onClick: this.play.bind(null, 0, 2), value: this.state.board[0][2]})
            )
          ), 
          React.createElement("tr", {className: "tictactoe-grid-bottom"}, 
            React.createElement("td", {className: "tictactoe-grid-right"}, 
              React.createElement(Button, {onClick: this.play.bind(null, 1, 0), value: this.state.board[1][0]})
            ), 
            React.createElement("td", {className: "tictactoe-grid-right"}, 
              React.createElement(Button, {onClick: this.play.bind(null, 1, 1), value: this.state.board[1][1]})
            ), 
            React.createElement("td", null, 
              React.createElement(Button, {onClick: this.play.bind(null, 1, 2), value: this.state.board[1][2]})
            )
          ), 
          React.createElement("tr", null, 
            React.createElement("td", {className: "tictactoe-grid-right"}, 
              React.createElement(Button, {onClick: this.play.bind(null, 2, 0), value: this.state.board[2][0]})
            ), 
            React.createElement("td", {className: "tictactoe-grid-right"}, 
              React.createElement(Button, {onClick: this.play.bind(null, 2, 1), value: this.state.board[2][1]})
            ), 
            React.createElement("td", null, 
              React.createElement(Button, {onClick: this.play.bind(null, 2, 2), value: this.state.board[2][2]})
            )
          )
        )
      )
