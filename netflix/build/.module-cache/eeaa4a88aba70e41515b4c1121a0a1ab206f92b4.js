        ...
        React.createElement("table", {className: "table-tictactoe"}, 
          React.createElement("tr", {className: "tictactoe-grid-bottom"}, 
            React.createElement("td", {className: "tictactoe-grid-right"}, 
              React.createElement("button", {className: "space", "data-tag": "topLeft", onClick: this.play.bind(null, 0, 0, 'topLeft')}, this.state.board[0][0])
            ), 
            React.createElement("td", {className: "tictactoe-grid-right"}, 
              React.createElement("button", {className: "space", "data-tag": "topMid", onClick: this.play.bind(null, 0, 1, 'topMid')}, this.state.board[0][1])
            ), 
            React.createElement("td", null, 
              React.createElement("button", {className: "space", "data-tag": "topRight", onClick: this.play.bind(null, 0, 2, 'topRight')}, this.state.board[0][2])
            )
          ), 
          React.createElement("tr", {className: "tictactoe-grid-bottom"}, 
            React.createElement("td", {className: "tictactoe-grid-right"}, 
