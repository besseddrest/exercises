...
var Category = React.createClass({displayName: "Category",
  ...
  eachTitle: function(titleData, i) {
    ...
    return (
      React.createElement(Title, {onClick: this.handleClick.bind(this, i, titleData), titleData: titleData, key: titleData.id, index: i})
    );
  },

  handleClick: function(i, props) {
    console.log('You clicked:' + props.titleData);
  },
        ...
        React.createElement("div", {className: "container"}, 
          ...
          React.createElement("div", {className: "row"}, 
            React.createElement("div", {className: "col-xs-12"}, 
              "Details of the title will go here, but initially this will be hidden", React.createElement("br", null), 
...
var Title = React.createClass({displayName: "Title",
  ...
  render: function() {
    return (
      React.createElement("div", {className: "title-thumb col-xs-4"}, 
