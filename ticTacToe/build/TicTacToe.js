      ...
      React.createElement("div", {className: "game"}, 
        React.createElement("table", {className: "table-tictactoe"}, 
          React.createElement("tr", {className: "tictactoe-grid-bottom"}, 
            React.createElement("td", {className: "tictactoe-grid-right"}, React.createElement("button", {className: "space", onClick: this.play.bind(this, 0, 0)}, this.state.board[0][0])), 
            React.createElement("td", {className: "tictactoe-grid-right"}, React.createElement("button", {className: "space", onClick: this.play.bind(this, 0, 1)}, this.state.board[0][1])), 
            React.createElement("td", null, React.createElement("button", {className: "space", onClick: this.play.bind(this, 0, 2)}, this.state.board[0][2]))
          ), 
          React.createElement("tr", {className: "tictactoe-grid-bottom"}, 
            React.createElement("td", {className: "tictactoe-grid-right"}, React.createElement("button", {className: "space", onClick: this.play.bind(this, 1, 0)}, this.state.board[1][0])), 
            React.createElement("td", {className: "tictactoe-grid-right"}, React.createElement("button", {className: "space", onClick: this.play.bind(this, 1, 1)}, this.state.board[1][1])), 
            React.createElement("td", null, React.createElement("button", {className: "space", onClick: this.play.bind(this, 1, 2)}, this.state.board[1][2]))
          ), 
          React.createElement("tr", null, 
            React.createElement("td", {className: "tictactoe-grid-right"}, React.createElement("button", {className: "space", onClick: this.play.bind(this, 2, 0)}, this.state.board[2][0])), 
            React.createElement("td", {className: "tictactoe-grid-right"}, React.createElement("button", {className: "space", onClick: this.play.bind(this, 2, 1)}, this.state.board[2][1])), 
            React.createElement("td", null, React.createElement("button", {className: "space", onClick: this.play.bind(this, 2, 2)}, this.state.board[2][2]))
          )
        )
      )
    )
